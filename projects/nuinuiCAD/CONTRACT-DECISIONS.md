...
3. platform標準または既存nuinuiCAD ruleから一意に決まる事項をcontractへ直接記録する。
4. 一意に決まらないproduct decisionだけをユーザーへ確認する。
5. 決定後、Issue本文・Contract label・Manual E2E plan・dependencyを同じcheckpointで整合させる。
